...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="views/layouts/assets/img/favicon.ico">
    
    <!-- CSS 
    ========================= -->

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="views/layouts/assets/css/plugins.css">
                ...
                <div class="col-12">
                    ...
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="header_account">
                            <ul>
                                <li class="language"><a href="#"><img src="views/layouts/assets/img/logo/language.png" alt=""> english <i class="ion-chevron-down"></i></a>
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                <li class="menu-item-has-children active"><a href="index.php">Home</a></li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-md-4 col-sm-4 col-4">
                            <div class="logo">
                                <a href="index.php"><img src="views/layouts/assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="header_right_box">
                                ...
                                <div class="header_configure_area">
                                    <div class="header_wishlist">
                                        <a href="index.php?page=wishlist"><i class="icon-heart"></i>
                                    ...
                                    <div class="mini_cart_wrapper">
                                        ...
                                        <div class="mini_cart">
                                            <div class="mini_cart_inner">
                                                ...
                                                <div class="cart_item">
                                                   <div class="cart_img">
                                                       <a href="#"><img src="views/layouts/assets/img/s-product/product.jpg" alt=""></a>
                                                   </div>
                                                    <div class="cart_info">
                                                ...
                                                <div class="cart_item">
                                                   <div class="cart_img">
                                                       <a href="#"><img src="views/layouts/assets/img/s-product/product2.jpg" alt=""></a>
                                                   </div>
                                                    <div class="cart_info">
                                            ...
                                            <div class="mini_cart_footer">
                                               <div class="cart_button">
                                                ...
                                                <div class="cart_button">
                                                    <a class="active" href="index.php?page=checkout">Checkout</a>
                                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="main_menu menu_position text-left"> 
                                <nav>  
                                    <ul>
                                        <li><a class="active"  href="index.php?page=home">home</a>
                                        </li>
                                        <li class="mega_items"><a href="index.php?page=shop">shop</a></li>
                        ...
                        <div class="col-lg-3">
                            <div class="call_support text-right">
                                <p><i class="icon-phone-call" aria-hidden="true"></i> <span>Call us:  <a href="tel:0123456789">092656260</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
