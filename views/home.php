...
<section class="slider_section mb-80">
    <div class="slider_area slider_carousel owl-carousel">
        <div class="single_slider d-flex align-items-center" data-bgimg="views/layouts/assets/img/slider/slider1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="slider_content">
                            ...
                            <a class="button" href="index.php?page=shop">shopping now <i
        ...
        <div class="single_slider d-flex align-items-center" data-bgimg="views/layouts/assets/img/slider/slider2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="single_slider d-flex align-items-center" data-bgimg="views/layouts/assets/img/slider/slider3.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="slider_content">
            ...
            <div class="col-lg-4 col-md-4">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="index.php?page=shop"><img src="views/layouts/assets/img/bg/banner1.jpg" alt=""></a>
                    </div>
                </figure>
            </div>
            <div class="col-lg-4 col-md-4">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="index.php?page=shop"><img src="views/layouts/assets/img/bg/banner2.jpg" alt=""></a>
                    </div>
                </figure>
            </div>
            <div class="col-lg-4 col-md-4">
                <figure class="single_banner">
                    <div class="banner_thumb">
                        <a href="index.php?page=shop"><img src="views/layouts/assets/img/bg/banner3.jpg" alt=""></a>
                    </div>
                </figure>
            </div>
        </div>
                ...
                <div class="categories_product_inner categories_column7 owl-carousel">
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category1.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Body Parts</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category2.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Car engine</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category3.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Interiors</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category4.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Lighting & lamp</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category5.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Repair Parts</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category6.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Smart Devices</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/s-product/category7.jpg"
                                    alt=""></a>
                        </div>
                        <div class="categories_product_content">
                            <h4><a href="index.php?page=shop"> Wheels & Tires</a></h4>
                        </div>
                    </div>
                    <div class="single_categories_product">
                        <div class="categories_product_thumb">
                ...
                <div class="col-12">
                    ...
                    <div class="product_tab_btn">
                        <ul class="nav" role="tablist" id="nav-tab">
                            <li>
                                <a class="active" data-bs-toggle="tab" href="#Sellers" role="tab"
                                    aria-controls="Sellers" aria-selected="true">
                                    Best Sellers
                                </a>
                            </li>
                            <li>
                                <a data-bs-toggle="tab" href="#Featured" role="tab" aria-controls="Featured"
                                    aria-selected="false">
                                    Featured Products
                                </a>
                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/bg/banner4.jpg" alt=""></a>
                        </div>
                    </figure>
                </div>
                <div class="col-lg-6 col-md-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="index.php?page=shop"><img src="views/layouts/assets/img/bg/banner5.jpg" alt=""></a>
                        </div>
                    </figure>
                </div>
            </div>
                                    ...
                                    <div class="product_content">
                                        ...
                                        <div class="product_desc">
                                            <p>Nunc facilisis sagittis ullamcorper. Proin lectus ipsum, gravida et
                                                mattis vulputate, tristique ut lectus. Sed et lorem nunc.</p>
                                        </div>
                                        <div class="action_links">
                                            <ul>
                ...
                <div class="blog_container blog_column4 owl-carousel">
                        ...
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="views/layouts/assets/img/blog/blog1.jpg"
                                            alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <h4><a href="blog-details.html">Aenean et nulla sociosqu ad litora torquent per</a>
                                    </h4>
                                    <div class="post_meta">
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="views/layouts/assets/img/blog/blog2.jpg"
                                            alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="views/layouts/assets/img/blog/blog3.jpg"
                                            alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="views/layouts/assets/img/blog/blog4.jpg"
                                            alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <h4><a href="blog-details.html">Aenean et nulla sociosqu ad litora torquent per</a>
